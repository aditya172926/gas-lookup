...
pub async fn gas_spent() {
    ...
    fetch_gas(&address, start_block, end_block).await;

    // match fetch_gas(&address, start_block, end_block).await {
    //     Ok(result) => result,
    //     Err(error) => {
...
#[wasm_bindgen]
pub async fn classify_address(address: String) -> String {
...
#[wasm_bindgen]
pub fn verify_address(address: &str) {
...
#[wasm_bindgen]
pub async fn format_date(date: &str) -> u64 {
...
#[wasm_bindgen]
pub async fn get_blocks(day: u32, month: u32, year: i32) -> u64 {
